...
public final class DistanceFunctions {
	...
	/**
	 * 一个 {@linkplain DistanceFunction distance function} 对象，用于计算
	 * 两个 {@linkplain EuclideanCoordinate Euclidean 之间的距离
	 * 坐标}。
	 */
	...
	/**
	 * 一个 {@linkplain DistanceFunction distance function} 对象，用于计算
	 * 两个坐标之间的距离，由 {@linkplain
	 * java.util.List lists} 的 {@link java.lang.Integer} 中。
	 */
